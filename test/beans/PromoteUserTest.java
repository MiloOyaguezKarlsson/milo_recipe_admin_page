 ...
 */
public class PromoteUserTest {

    Connection connection;
    WebDriver webDriver;

    public PromoteUserTest() {
    }
    ...
    public void tearDown() {
        try {
            ...
            Logger.getLogger(PromoteUserTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    /**
     * Test of promote method, of class UserBean.
     */
    @Test
    public void testPromote() {
        try {
            ...
            int newRights = 0;
            if (result.next()) {
                newRights = result.getInt("rights");
            }
            
            // ta bort användaren
            UserResource.deleteUser("aaaaa");
            
            assertEquals(2, newRights);
